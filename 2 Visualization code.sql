...
SELECT
	balances.dt,
	sum(balances.transaction_balance_change) AS sum_transaction_balance_change,
	sum(balances.transaction_balance_change_cs) AS sum_transaction_balance_change_cs,
	sum(balances.classes) AS sum_classes,
	sum(balances.classes_cs) AS sum_classes_cs,
	sum(balances.balance) AS sum_balance
FROM
	balances
GROUP BY
	balances.dt
